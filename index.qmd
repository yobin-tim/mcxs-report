...
ext.sim.sample <- ext.sampling(parameters, ext.sim.struct, ext.sim.prior, artificialdata)
```
...
ext.sample <- ext.sampling(parameters, ext.sim.struct, ext.sim.prior, mydata)
```
