...
# Research Question
The objective of this paper is to estimate and quantify the impact of monetary policy shocks on different indicators of the housing market such as housing prices, housing transactions/sales, and home loan rates within an economy. Understanding these effects is crucial in understanding how money affects a key factor of the real side of the economy. I formulate this question within a SVAR framework and make use of @waggoner2003a algorithm to sample for posterior draws of the coefficient matrices. I further extend the model using common parameterisation of hierarchical priors and estimate the model for better accuracy.
...
#| code-fold: true
#| code-summary: "Imposing lower-triangular exclusion restrictions"
...
#| code-fold: true
#| code-summary: "List of Parameters"
...
#| code-fold: true
#| code-summary: "Posterior Function"
...
#| code-fold: true
#| code-summary: "Function to sample B0 and Bplus posteriors"
...
***Step 1:*** The following code computes the prior, initialises matrices to store results, and samples the draws for the actual data.
```{r  ext2 Running extension for actual data, eval = FALSE, include=TRUE}
...
$$
where $\sigma^2_{T \times 1} = (\exp(h_1), \dots, \exp(h_T))$. This introduction of stochastic volatility transforms the posterior parameters of $(B_+,B_0)$ as follows:
$$
\begin{align*}
...
#| code-fold: true
#| code-summary: "Gibbs Sampler for Extension 3"
